...
class __TwigTemplate_1ce44797704654f59e4f141ac13c5bb3be83c895b4637f898a90d6271154b842 extends Twig_Template
{
        ...
        <div class=\"tab-pane\" id=\"tab-pane1\">
            <div class=\"row\" id=\"topTool\" style=\"position:relative;\" >
                <div class=\"col-sx-4\" style=\" float: left;margin-right: 5px;\">
                    <input type=\"text\" pts=20 sear1=\"kh_name\" sear=\"khm_customer.name\" placeholder=\"企业名称\"/>
                </div>
                <div class=\"col-sx-4\" style=\" float: left;margin-right: 5px;\">
                    <input type=\"text\" pts=20 sear1=\"kh_num\" sear=\"khm_customer.customer_num\" placeholder=\"客户编码\"/>
                </div>
                 <!-- <div class=\"col-sx-4\" style=\" float: left;margin-right: 5px;\">
                ...
                <div id=\"heightsearch1\" class=\"col-sx-12\" style=\"margin-top:30px;width:100%;position: absolute; background: #fff;padding: 20px 0px; display: none;z-index:1042;\">
                    <div class=\"row\">
                        ...
                        <div class=\"col-sx-4\" style=\" float: left; margin-bottom:5px;\">
                            ...
                            <input type=\"text\" gjs=20 sear1=\"kh_name\" sear=\"khm_customer.name\" />
                        </div>
                        <div class=\"col-sx-4\" style=\" float: left; margin-bottom:5px;\">
                            <label>客户编码</label>
                            <select>
                            ...
                            <input type=\"text\" gjs=20 sear1=\"kh_num\" sear=\"khm_customer.customer_num\">
                        </div>
                        <div class=\"col-sx-4\" style=\"float:left; margin-bottom:5px;\">
                            <label>仓位</label>
                            <select>
...
\t\t\t\t\t\t\t\t<option value=\"3\"> 未通过</option>
                       ...
                       <!-- <div class=\"col-sx-4\" style=\"float:left; margin-bottom:5px;\">
                            ...
                            <input type=\"text\" gjs=9 sear=\"yq_money\" data-type=\"gj\">
                        </div>-->
                        <!-- <div class=\"col-sx-4\" style=\" float: left; margin-bottom:5px;\">
                            <label>激活时间</label>
                            <select>
...
//                  console.log(time);
                ...
                html +=
                    ...
                    '<label class=\"pos-rel\"><i class=\"iconBnt fa fa-info-circle\" style=\"color:'+((data[i]['Remark'] == undefined && data[i]['Remark'] != []) ? \"\" : (data[i]['Remark'].length > 0 ? 'red' : \"\"))+'\"  data-rel=\"tooltip\" data-placement=\"right\" data-html=\"true\" title=\"'+cs.getRemark(data[i]['Remark'])+'\" ></i></label></td>'+
